...
class Suburb(wx.Frame):
    def __init__(self, parent):
        wx.Frame.__init__(self, parent, id=wx.ID_ANY, title=u"Airbnb Data Software", pos=wx.DefaultPosition,
                          size=wx.Size(1450, 600), style=wx.DEFAULT_FRAME_STYLE | wx.TAB_TRAVERSAL)
        ...
        m_comboBox1Choices = []
        self.m_comboBox1 = wx.ComboBox(self.m_panel2, wx.ID_ANY, u"Suburb", wx.DefaultPosition, wx.DefaultSize,
                                       m_comboBox1Choices, 0)
        gSizer3.Add(self.m_comboBox1, 0, wx.ALL, 5)

        self.m_staticText2 = wx.StaticText(self.m_panel2, wx.ID_ANY, u"Check-In Date", wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        m_comboBox2Choices = []
        self.m_comboBox2 = wx.ComboBox(self.m_panel2, wx.ID_ANY, u"Date", wx.DefaultPosition, wx.DefaultSize,
                                       m_comboBox2Choices, 0)
        gSizer3.Add(self.m_comboBox2, 0, wx.ALL, 5)

        self.m_staticText3 = wx.StaticText(self.m_panel2, wx.ID_ANY, u"Check-Out Date", wx.DefaultPosition,
                                           wx.DefaultSize, 0)
        ...
        m_comboBox3Choices = []
        self.m_comboBox3 = wx.ComboBox(self.m_panel2, wx.ID_ANY, u"Date", wx.DefaultPosition, wx.DefaultSize,
