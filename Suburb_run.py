...
class Suburb ( wx.Frame ):
    ...
    def __init__( self, parent ):
        wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"Airbnb Data Software", pos = wx.DefaultPosition, size = wx.Size( 874,550 ), style = wx.DEFAULT_FRAME_STYLE|wx.TAB_TRAVERSAL )
        ...
        self.m_scrolledWindow1.SetScrollRate( 0, 20)
    ...
    def ScreenSize(self, event):
        ...
        self.m_scrolledWindow1.SetVirtualSize(frame_size)
        self.m_scrolledWindow1.SetSize(frame_size)
        event.Skip()
