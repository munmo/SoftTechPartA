...
class Main ( wx.Frame ):
	...
	def __init__( self, parent ):
		...
		fgSizer15.Add( self.m_button1, 0, wx.ALL, 5 )
		...
		fgSizer15.Add( self.m_button2, 0, wx.ALL, 5 )
		...
		fgSizer15.Add( self.m_button3, 0, wx.ALL, 5 )
		...
		self.m_panel1.SetSizer( fgSizer15 )
		self.m_panel1.Layout()
		fgSizer15.Fit( self.m_panel1 )
