...
class Keyword(wx.Frame):
    ...
    def OnSearch(self, event):
        try:
            ...
            num_rows = len(df_listings_filtered)
            ...
            for row, (_, row_data) in enumerate(df_listings_filtered.iterrows()):
        ...
        if df_calendar_filtered.empty or df_listings_filtered.empty:
            wx.MessageBox(f"No data available for the selected date range with keyword '{keyword}'.", "Info",
